...
# Pipeline (registry + collect/verify) lives in pipeline.py. Re-exported here
# as module-level names so tests can monkeypatch cli._collect / _verify_pending.
from . import pipeline  # noqa: E402

SOURCE_NAMES = pipeline.SOURCE_NAMES
